...
public class OVRSkeleton : MonoBehaviour
{
    ...
    private bool ShouldInitialize()
    {
        ...
        {
#if UNITY_EDITOR
			//return OVRInput.IsControllerConnected(OVRInput.Controller.Hands); => OVR UPGRADE WARNING Return false when using only Right hand at the begining cause Controller.RHand & Controller.Hands dosn't give Controller.Hands;
			return true;
#else
            return true;
#endif
