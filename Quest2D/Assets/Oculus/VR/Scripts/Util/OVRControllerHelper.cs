...
public class OVRControllerHelper : MonoBehaviour
{
    ...
    void Update()
    {
		...
		// we're forcing the controller to always load as Mesh Browser has it's own logic to show and hide the controller models accordingly to ensure same behaviour on all platforms
		//Follow up in this ticket : #28979
